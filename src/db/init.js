  ...
  try {
    await client.query(`
      CREATE TABLE IF NOT EXISTS users (
        ...
        own_provider  TEXT DEFAULT NULL,
        own_model     TEXT DEFAULT NULL,
      ...
      ALTER TABLE users ADD COLUMN IF NOT EXISTS own_provider TEXT DEFAULT NULL;
      ALTER TABLE users ADD COLUMN IF NOT EXISTS own_model TEXT DEFAULT NULL;
    `);
